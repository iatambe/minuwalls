	...
	*/
	...
	private void showInstructionDialog() {
		dialogBox.showMessageDialog(null, "Welcome to MinuWalls, the best GridWorld game on Earth!\n"
			...
			"Welcome to MinuWalls!", JOptionPane.INFORMATION_MESSAGE);
		dialogBox.showMessageDialog(null, "Avoid the walls that trail from your opponent's bike. "
		...
		dialogBox.showMessageDialog(null, "For Player 2, the controls are WASD." + '\n' 
			+ "W moves up, A moves left, S moves down, D moves right.",
			"Instructions #3", JOptionPane.INFORMATION_MESSAGE);
		dialogBox.showMessageDialog(null, "There are powerups in the game as well. "
			+ "Collect them and you will be able to gain an advantage or disadvantage.",
			"Instructions #4", JOptionPane.INFORMATION_MESSAGE);
		dialogBox.showMessageDialog(null, "The game begins when the stoplight turns green. " + '\n'
			+ "The first person to reach 10 points wins!",
			"Instructions #5", JOptionPane.INFORMATION_MESSAGE);
		return;
	}	
